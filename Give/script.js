...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Shop cart functionality with icon (kept for consistency)
    let cart = [];
    ...
    // Give form submission
    document.getElementById('give-form').addEventListener('submit', (e) => {
        e.preventDefault();
        const amount = document.getElementById('amount').value;
        const name = document.getElementById('name').value;
        const email = document.getElementById('email').value;
        alert(`Thank you, ${name}! Your demo donation of $${amount} has been recorded. (This is a demo - no real payment processed)`);
        document.getElementById('give-form').reset();
    });
